...
/* ------------------------------------------------------------------ */
/*  Login page — OAuth-first, collapsible email+password section       */
/* ------------------------------------------------------------------ */
...
export function LoginClient() {
  ...
  return (
    <div>
      <h1 className="text-xl font-semibold tracking-[-0.02em]">Bejelentkezés</h1>
      <p className="text-muted-foreground mt-1 text-sm">Jelentkezzen be fiókjába.</p>
