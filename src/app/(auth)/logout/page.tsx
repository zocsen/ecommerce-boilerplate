...
export default function LogoutPage() {
  ...
  useEffect(() => {
    ...
    async function doLogout() {
      ...
      if (result.success) {
        ...
        setError(result.error ?? "Hiba a kijelentkezeskor.");
      }
    }
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center gap-4">
        <p className="text-lg font-medium tracking-tight">Kijelentkezes</p>
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <p className="text-sm text-muted-foreground">Kijelentkezes...</p>
    </div>
  );
}
