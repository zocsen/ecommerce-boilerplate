 ...
 */
export function getFullFromAddress(category: EmailCategory, displayName?: string): string {
...
export function shouldRedirectToTestRecipient(): boolean {
  return process.env.NODE_ENV === "development" && !!process.env.RESEND_TEST_RECIPIENT;
}
