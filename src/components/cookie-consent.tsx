...
function ConsentToggle({
  ...
  return (
    ...
    >
      <Switch.Thumb
        className={cn(
          "bg-background pointer-events-none block size-5 rounded-full shadow-sm ring-0 transition-transform duration-300 ease-out",
...
export function CookieConsentBanner() {
  ...
  return (
    <div
      ...
      className="border-border bg-background border-t shadow-lg"
    >
