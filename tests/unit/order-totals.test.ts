...
function computeShippingFee(subtotal: number, baseFee: number, freeThreshold: number): number {
...
function computeOrderTotals(
  ...
  const shippingFee = computeShippingFee(subtotal, shippingBaseFee, freeShippingThreshold);
