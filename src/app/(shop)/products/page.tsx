...
export const metadata: Metadata = {
  title: "Termékek",
  description:
    "Böngészd prémium termékkínálatunkat. Szűrj kategória, ár és elérhetőség szerint.",
}
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
      ...
      <div className="mt-8 mb-10">
        <h1 className="text-4xl font-semibold tracking-[-0.03em] text-foreground lg:text-5xl">
          Termékek
        </h1>
